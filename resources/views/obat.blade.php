        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search">
                    ...
                    <button class="btn btn-outline-primary" type="submit"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <form class="d-flex">
                    ...
                    <a href="{{ route('profile') }}"><img src="{{ asset('img/admin-profile.png') }}" alt="" class="img-fluid"></a>
                </form>
            </div>
        </div>
    </nav>
    ...
    <div class="content-container">
        <div class="sidebar">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="{{route('apotik')}}"><svg xmlns="http://www.w3.org/2000/svg" class="me-2" width="17"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{[route('obat')}}"><svg xmlns="http://www.w3.org/2000/svg" class="me-2" width="15"
